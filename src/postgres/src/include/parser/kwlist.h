...
PG_KEYWORD("account", _YB_ACCOUNT_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("backfill", _YB_BACKFILL_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("change", _YB_CHANGE_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("colocated", _YB_COLOCATED_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("colocation", _YB_COLOCATION_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("failed_login_attempts", _YB_FAILED_LOGIN_ATTEMPTS_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("hash", _YB_HASH_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("nonconcurrently", _YB_NONCONCURRENTLY_P, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("none", NONE, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("noprofile", _YB_NOPROFILE_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("profile", _YB_PROFILE_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("split", _YB_SPLIT_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tablegroup", _YB_TABLEGROUP_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("tablegroups", _YB_TABLEGROUPS_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("tablets", _YB_TABLETS_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("unlock", _YB_UNLOCK_P, UNRESERVED_KEYWORD, BARE_LABEL)
