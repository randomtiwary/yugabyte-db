...
PG_CMDTAG(CMDTAG_ALTER_TABLEGROUP, "ALTER TABLEGROUP", false, false, false)
...
PG_CMDTAG(CMDTAG_BACKFILL_INDEX, "BACKFILL INDEX", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_TABLEGROUP, "CREATE TABLEGROUP", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_TABLEGROUP, "DROP TABLEGROUP", false, false, false)
...
/* Yugabyte: Allow trigger on TRUNCATE TABLE */
PG_CMDTAG(CMDTAG_TRUNCATE_TABLE, "TRUNCATE TABLE", true, false, false)
