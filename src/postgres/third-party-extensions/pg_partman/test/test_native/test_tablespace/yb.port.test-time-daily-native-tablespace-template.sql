...
CREATE TABLESPACE mytablespace LOCATION ''; -- YB: Requires folder creation for tablespace and running tablespace creation before test.
...
ALTER INDEX partman_test.time_taptest_table_template_pkey SET TABLESPACE mytablespace ; -- YB: will fail with ERROR:  cannot set tablespace for primary key index
